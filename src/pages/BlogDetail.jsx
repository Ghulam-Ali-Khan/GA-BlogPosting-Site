    ...
    <>
      <div className="container single-content">
                    ...
                    <div className="col-md-6">
                        <div className="entry-meta align-items-center meta-2 font-small color-muted">
                            <p className="mb-5">
                                ...
                                By <a href="author.html"><span className="author-name font-weight-bold">Barbara Cartland</span></a>
                            </p>
                            <span className="mr-10"> 15 April 2023</span>
            ...
            <figure className="image mb-30 m-auto text-center border-radius-10">
                <img className="border-radius-10" src="assets/imgs/news/news-1.jpg" alt="post-title" />
            </figure>
            ...
            <article className="entry-wraper mb-50">
                ...
                <div className="entry-main-content dropcap wow fadeIn animated">
                    ...
                    <figure className="wp-block-gallery columns-3 wp-block-image">
                        <ul className="blocks-gallery-grid">
                            <li className="blocks-gallery-item"><a href="#"><img className="border-radius-5" src="assets/imgs/news/thumb-2.jpg" alt="" /></a></li>
                            <li className="blocks-gallery-item"><a href="#"><img className="border-radius-5" src="assets/imgs/news/thumb-3.jpg" alt="" /></a></li>
                            <li className="blocks-gallery-item"><a href="#"><img className="border-radius-5" src="assets/imgs/news/thumb-4.jpg" alt="" /></a></li>
                        </ul>
                    ...
                    <div className="wp-block-image">
                        <figure className="alignleft is-resized">
                            <img className="border-radius-5" src="assets/imgs/news/thumb-11.jpg" />
                ...
                <div className="single-social-share clearfix wow fadeIn animated">
                    <div className="entry-meta meta-1 font-small color-grey float-start mt-10">
                        <span className="hit-count mr-15"><i className="elegant-icon icon_comment_alt mr-5"></i>182 comments</span>
                        <span className="hit-count mr-15"><i className="elegant-icon icon_like mr-5"></i>268 likes</span>
                        <span className="hit-count"><i className="elegant-icon icon_star-half_alt mr-5"></i>Rate: 9/10</span>
                    </div>
                    <ul className="header-social-network d-inline-block list-inline float-md-end mt-md-0 mt-4">
                        <li className="list-inline-item text-muted"><span>Share this: </span></li>
                        <li className="list-inline-item"><a className="social-icon fb text-xs-center" target="_blank" href="#"><i className="elegant-icon social_facebook"></i></a></li>
                        <li className="list-inline-item"><a className="social-icon tw text-xs-center" target="_blank" href="#"><i className="elegant-icon social_twitter "></i></a></li>
                        <li className="list-inline-item"><a className="social-icon pt text-xs-center" target="_blank" href="#"><i className="elegant-icon social_pinterest "></i></a></li>
                                ...
                                <div className="row mb-40 list-style-2">
                                    <div className="col-md-4">
                                        <div className="post-thumb position-relative border-radius-5">
                                            <div className="img-hover-slide border-radius-5 position-relative" style={{backgroundImage: "(assets/imgs/news/news-13.jpg)"}}>
                        ...
                        <ul className="list-post">
                            <li className="mb-30">
                                <div className="d-flex hover-up-2 transition-normal">
                                    ...
                                    <div className="post-content media-body">
                                        <h6 className="post-title mb-15 text-limit-2-row font-medium"><a href="single.html.htm">The Best Time to Travel to Cambodia</a></h6>
                                        <div className="entry-meta meta-1 float-start font-x-small text-uppercase">
                            ...
                            <li className="mb-10">
                                <div className="d-flex hover-up-2 transition-normal">
                                    ...
                                    <div className="post-content media-body">
                                        <h6 className="post-title mb-15 text-limit-2-row font-medium"><a href="single.html.htm">20 Photos to Inspire You to Visit Cambodia</a></h6>
                                        <div className="entry-meta meta-1 float-start font-x-small text-uppercase">

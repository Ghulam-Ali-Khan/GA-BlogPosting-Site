    ...
    <footer className="pt-50 pb-20 bg-grey">
        <div className="container">
                ...
                <div className="col-lg-3 col-md-6">
                    <div className="sidebar-widget widget_tagcloud wow fadeInUp animated mb-30" data-wow-delay="0.2s">
                        ...
                        <div className="tagcloud mt-50">
                            <a className="tag-cloud-link" href="category.html.htm">beautiful</a>
                            <a className="tag-cloud-link" href="category.html.htm">New York</a>
                            <a className="tag-cloud-link" href="category.html.htm">droll</a>
                            <a className="tag-cloud-link" href="category.html.htm">intimate</a>
                            <a className="tag-cloud-link" href="category.html.htm">loving</a>
                            <a className="tag-cloud-link" href="category.html.htm">travel</a>
                            <a className="tag-cloud-link" href="category.html.htm">fighting </a>
                        </div>
                    </div>
                </div>
            ...
            <div className="footer-copy-right pt-30 mt-20 wow fadeInUp animated">
                <p className="float-md-start font-small text-muted">© 2023, Stories - Personal Blog HTML Template </p>
                <p className="float-md-end font-small text-muted">
